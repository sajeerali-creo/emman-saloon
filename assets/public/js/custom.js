...
( function( $ ) {
	...
	( function() {
		...
		menuToggle.on( 'click.twentysixteen', function() {
			...
			$('body').add( siteHeaderMenu ).toggleClass( 'toggled-on-body' );
...
function siteFooter() {
  ...
  if($('.testimonial_slider').length){
	$('.testimonial_slider').each(function(index, slider){	
		$(slider).slick({
	...
	Emc = {
		...
		InView : {
			...
			init : function() {
				...
				inView.offset( 50 );
				Emc.InView.createInViewListeners();

				$( window ).on( 'scroll', Emc.InView.onScroll );
			...
			onScroll : function() {
				...
				$( 'body' ).toggleClass( 'scrolled-up', $( window ).scrollTop() != 0 && $( window ).scrollTop() < Emc.InView.scrollTop  );
				Emc.InView.scrollTop = $( window ).scrollTop();
...
$(function() {
    ...
    $('#submitcontactpopup').click(function (e) {
        e.preventDefault();
        formValid = true;
        var is_name=document.getElementById("name2").value;
        if(isEmpty(is_name)){
            $("#name2").removeClass("wpcf7-not-valid").addClass("wpcf7-not-valid");
            formValid = false;
        }
        else{
            $("#name2").removeClass("wpcf7-not-valid");
		}
		var email2=document.getElementById("email2").value;
        if(isEmpty(email2)){
            $("#email2").removeClass("wpcf7-not-valid").addClass("wpcf7-not-valid");
           formValid = false;
        }
        else{
            $("#email2").removeClass("wpcf7-not-valid");				
        }	
        var is_phone=document.getElementById("phone2").value;
        if(isEmpty(is_phone)){
            $("#phone2").removeClass("wpcf7-not-valid").addClass("wpcf7-not-valid");
           formValid = false;
        }
        else{
            $("#phone2").removeClass("wpcf7-not-valid");				
        }			
        if(formValid){
            $("#js-index-request-form-2").submit();
        }	
    });	
    ...
    var gotFControl,controlVal="";jQuery(document).on("focus",'input[type="text"], input[type=email], input[type=number], input[type=tel], input[type=url]',function(){jQuery(this).removeClass("selected-form-control"),jQuery(this).hasClass("wpcf7-not-valid")&&(gotFControl=this,controlVal=jQuery(this).val()),jQuery(this).removeClass("wpcf7-not-valid"),jQuery(this).next().is("span")&&jQuery(this).next().remove()}),jQuery(document).on("blur",'input[type="text"], input[type=email], input[type=number], input[type=tel], input[type=url]',function(){var a=jQuery(this).val(),b=this;b==gotFControl&&controlVal==a&&jQuery(this).addClass("wpcf7-not-valid"),""!=jQuery.trim(a)&&jQuery(this).addClass("selected-form-control"),jQuery(this).next().is("span")&&jQuery(this).next().remove()}),jQuery(document).on("focus","textarea",function(){jQuery(this).removeClass("selected-form-control")}),jQuery(document).on("blur","textarea",function(){var a=jQuery(this).val();""!=jQuery.trim(a)&&jQuery(this).addClass("selected-form-control")});
