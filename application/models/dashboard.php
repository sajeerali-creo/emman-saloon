            ...
            <div class="col-lg-3 col-xs-12">
              ...
              <div class="small-box bg-yellow">
                ...
                <h4 style="font-size:22px;font-weight:bold;">Last Attended Class</h4><?php 
                 if(isset($arrCompletedCourse->courseName)){
                  ?><p>Course : <?php echo $arrCompletedCourse->courseName; ?></p>
                  <p>Class : <?php echo $arrCompletedCourse->class_name; ?></p>
                  <p>Date : <?php echo $arrCompletedCourse->class_time; ?></p>
                  <p>Time : <?php echo $arrCompletedCourse->class_time_exact; ?></p>
                  <p>Download Link : <?php if(!empty($arrCompletedCourse->download_recording)){ echo $arrCompletedCourse->download_recording; } else { echo "Link not available"; } ?></p><?php 
                }
                else{
                  ?><p>No Courses</p><?php
                }
                ...
                <a href="<?php echo base_url(); ?>securepanel/courses" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col --><?php
            } 
             ?>
