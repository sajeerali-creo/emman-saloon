...
define('REST_SUPERADMIN', "'2', '3', '4'");
define('REST_ADMIN', "'3', '4'");
define('REST_TEACHER',  "'4'");
define('REST_STUDENT',  "''");
...
define('PROJECT_NAME',                          'Eman Saloon');
define('VAT',                             		'5');
$strCopyRight = 'Copyright &copy; emansalon ' . date("Y");
define('PROJECT_COPYRIGHT',                     $strCopyRight);