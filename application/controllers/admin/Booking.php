...
class Booking extends BaseController
{
    ...
    function addNewSupplierInformation()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $result = $this->booking_model->addNewSupplier($supplierInfo);
                if($result > 0){
    ...
    function editSupplier($supplierId = NULL)
    {
        ...
        else
        {
            ...
            $data['supplierInfo'] = $this->booking_model->getSupplierInfo($supplierId);
    ...
    function updateSupplier()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $result = $this->booking_model->updateSupplier($supplierInfo, $supplierId);
                if($result){                    
    ...
    function deleteSupplier()
    {
        ...
        else
        {
            ...
            $result = $this->booking_model->deleteSupplier($supplierId, $supplierInfo);
    ...
    function activeDeactiveSurvey(){
        if(!$this->isSuperAdmin() && !$this->isMainAdmin() && !$this->isTeacher()){
            ...
            if(!empty($supplierId) && ($stat == 0 || $stat == 1)) {
                ...
                $result = $this->booking_model->updatSurvey($statusInfo, $supplierId);
