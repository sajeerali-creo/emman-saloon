<div class="container mb-3">
    ...
    <div class="row">
        <div class="mt-2 col-md-12">
            <form name="frmAddForm" id="frmAddForm" class="user" action="<?php echo base_url(); ?>securepanel/add-supplier-info" method="post"  enctype="multipart/form-data"><?php

                $txtTitle       = isset($txtTitle) ? $txtTitle : '';
                $txtCountry     = isset($txtCountry) ? $txtCountry : '';
                $txtCity        = isset($txtCity) ? $txtCity : '';
                $txtPostCode    = isset($txtPostCode) ? $txtPostCode : '';
                $txtPhone       = isset($txtPhone) ? $txtPhone : '';
                $txtFax         = isset($txtFax) ? $txtFax : '';
                $txtWeb         = isset($txtWeb) ? $txtWeb : '';
                $txtEmail       = isset($txtEmail) ? $txtEmail : '';
                $txtCatogory    = isset($txtCatogory) ? $txtCatogory : '';
