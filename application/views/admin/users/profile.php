                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="inputOldPassword" placeholder="Old password" name="oldPassword" maxlength="50" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="cNewPassword" placeholder="Confirm new password" name="cNewPassword" maxlength="50" required>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
