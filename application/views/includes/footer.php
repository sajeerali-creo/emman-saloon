    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url(); ?>assets/admin/vendor/chart.js/Chart.min.js"></script><?php
        
    if(basename(base_url(uri_string())) != 'dashboard'){
        ?><!-- Page level plugins -->
    ...
    if(basename(base_url(uri_string())) == 'calender-team'){
        ?><script src='<?php echo base_url(); ?>assets/admin/js/main.js'></script>
        <script src='<?php echo base_url(); ?>assets/admin/js/calender.js'></script><?php
    }
