    ...
    <div style="width: 19rem">
        ...
        <div class="row">
            <div class="card col-md-12 h-32vh">
                <div class="card-body d-flex align-items-center justify-content-center"><?php
                    ...
                    ?><form action="<?php echo base_url(); ?>serviceboy/login-user" method="post" class="user" id="login-form"><form>
                        <div class="form-group w-100">
                            <label for="txtUsername">Enter Your ID</label>
                            <input type="password" class="form-control" id="txtUsername" name="txtUsername" placeholder="Team ID">
                        </div>
